...
library, please see the corresponding [library resources](https://easyscience.github.io/peasy-lib).
...
If you use **EasyPeasy** application in your work,
please cite the specific version you used.

All official releases of the **EasyPeasy** application are archived
